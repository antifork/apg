...
/* $Id$ */
#line 201 "/usr/local/share/apg/apg.db"
/*
 *  $Id$
 *  apg.par.c
...
#line 229 "/usr/local/share/apg/apg.db"
#define _APG_PARSER_C
#line 1 "par.engine.c"
#include "tab.engine.h"
#line 231 "/usr/local/share/apg/apg.db"
/* mealy prototypes */
...
#line 239 "/usr/local/share/apg/apg.db"
...
#line 266 "/usr/local/share/apg/apg.db"
#define APG_OPEN                0
#define APG_CLOSE               1
...
#line 292 "/usr/local/share/apg/apg.db"
#if defined (__GNUC__) && !defined (__STRICT_ANSI__) && !defined (__ANSI__) && !defined(__cplusplus)
int           c_index[256] = {['#'] 1,[APG_SEPLINE] 2,[APG_SEPTOKEN] 3,['\''] 4,['\\'] 5,[' '] 6,['\t'] 6,['\n'] 7
};
#else
int           c_index[256];
#endif
...
static char *
strprg (AACHARx_ARG p, AAINT_ARG i)
AACHARx_DEC (p)
AAINT_DEC   (i)
{
    register int  l;
    ...
    else
	{
	    switch (*p_stream)
		{
		 ...
		 case '0':
		     ...
		     if (*(p_stream + 1) == 'x' || *(p_stream + 1) == 'X') apg_flags |= APG_HEXT;
		     else apg_flags |= APG_OCTT;
...
#line 625 "/usr/local/share/apg/apg.db"
static grill_t *
...
#line 694 "/usr/local/share/apg/apg.db"
...
static void
token_fatalerr (AAINT_ARG l_id, AAINT_ARG t_id, AAINT_ARG type, AAINT_ARG errn0, AAINT_ARG low, AAINT_ARG high, AACHARx_ARG token)
AAINT_DEC (l_id)
AAINT_DEC (t_id)
AAINT_DEC (type)
AAINT_DEC (errn0)
	...
	*p = '\\';
    ...
    switch (errn0)
	{
	 ...
	 case APG_EFEW:
	     ...
	     break;
#line 755 "/usr/local/share/apg/apg.db"
	}
...
#line 761 "/usr/local/share/apg/apg.db"
static void
...
#line 796 "/usr/local/share/apg/apg.db"
#ifdef __GNUC__
__inline
#else
#endif
...
#line 839 "/usr/local/share/apg/apg.db"
...
#line 902 "/usr/local/share/apg/apg.db"
	 case T_INT:
	 case T_U_32:
	 case T_SHORT:
	 case T_U_16:
...
#line 959 "/usr/local/share/apg/apg.db"
	 case T_STR:
	     {
		 strcpy (pp, token);
		 ...
		 if (strchr (token, APG_ACK))
			 ...
			 while ((ptr = (char *) strchr (ptr, APG_ACK)))
				 ...
				 *ptr = (char) strtol (bufftemp, NULL, 0);
				 ...
				 if (*ptr == '\0' || i == 0) token_fatalerr (EARG_3);
...
#line 1023 "/usr/local/share/apg/apg.db"
...
#line 1161 "/usr/local/share/apg/apg.db"
	}
    return;
}
...
#line 1166 "/usr/local/share/apg/apg.db"
...
#line 1193 "/usr/local/share/apg/apg.db"
void
...
#line 1315 "/usr/local/share/apg/apg.db"
grill_t      *
#if __STDC__
apg_parser (int q, ...)
#else
...
#line 1342 "/usr/local/share/apg/apg.db"
...
#line 1448 "/usr/local/share/apg/apg.db"
		     break;
		 default:	/* token */
...
#line 1480 "/usr/local/share/apg/apg.db"
    free (b_token);
...
#line 1511 "/usr/local/share/apg/apg.db"
