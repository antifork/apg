...
#line 769 "/usr/local/share/apg/apg.db"
#ifdef __GNUC__
__inline
#else
#endif
...
#line 807 "/usr/local/share/apg/apg.db"
...
#line 872 "/usr/local/share/apg/apg.db"
    case T_INT:
    case T_U_32:
    case T_SHORT:
    case T_U_16:
...
#line 928 "/usr/local/share/apg/apg.db"
    case T_STR:
      {
	strcpy (pp, token);
...
#line 1129 "/usr/local/share/apg/apg.db"
    }
  return;
}
...
#line 1158 "/usr/local/share/apg/apg.db"
void
...
#line 1274 "/usr/local/share/apg/apg.db"
grill_t *
#if __STDC__
apg_parser (int q, ...)
#else
...
#line 1396 "/usr/local/share/apg/apg.db"
	  break;
	default:		/* token */
...
#line 1427 "/usr/local/share/apg/apg.db"
  free (base_tokens);
...
#line 1456 "/usr/local/share/apg/apg.db"
