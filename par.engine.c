...
/* $Id$ */
#line 140 "/usr/local/share/apg/apg.db"
/*
 *  $Id$
 *  apg.par.c
...
#line 168 "/usr/local/share/apg/apg.db"
...
#line 171 "/usr/local/share/apg/apg.db"
...
#line 199 "/usr/local/share/apg/apg.db"
#define APG_OPEN                0
#define APG_CLOSE               1
#define APG_ACK          	0x06
...
#line 222 "/usr/local/share/apg/apg.db"
...
#line 249 "/usr/local/share/apg/apg.db"
#if __STDC__
...
mmap_ctrl(char * fn, int flag)
{
	...
	case APG_OPEN:
		...
		file_image=mmap(NULL, apg_stream_len, PROT_READ, MAP_PRIVATE, fd, 0);
...
#line 527 "/usr/local/share/apg/apg.db"
static grill_t *
...
#line 601 "/usr/local/share/apg/apg.db"
...
token_fatalerr(int l_id, int t_id, int type, int errn0, int low, int high, char * token)
	...
	case APG_EFEW:
		...
		break;
#line 653 "/usr/local/share/apg/apg.db"
	}
...
#line 659 "/usr/local/share/apg/apg.db"
static void
alloc_seg_t(char * r)
{
	seg_t *p;
...
#line 691 "/usr/local/share/apg/apg.db"
#ifdef __GNUC__
    __inline
#else
#endif
...
#line 728 "/usr/local/share/apg/apg.db"
...
token_analysis(char * token, int l_id, int t_id)
{
	...
	switch (LTYPE(l_id, t_id)) {
#line 778 "/usr/local/share/apg/apg.db"
	case T_INT:
	case T_U_32:
	case T_SHORT:
	case T_U_16:
...
#line 821 "/usr/local/share/apg/apg.db"
	case T_STR:
		{
			strcpy(pp, token);
...
#line 870 "/usr/local/share/apg/apg.db"
		if (!(LLOW(l_id, t_id) || 
			LHIGH(l_id, t_id)) || 
...
#line 986 "/usr/local/share/apg/apg.db"
	}
	return;
}
...
#line 991 "/usr/local/share/apg/apg.db"
...
#line 1012 "/usr/local/share/apg/apg.db"
void
...
#line 1114 "/usr/local/share/apg/apg.db"
grill_t *
#if __STDC__
apg_parser(int q,...)
#else
...
#endif
{
	...
	int i;
	int j;
#line 1134 "/usr/local/share/apg/apg.db"
        b_stream = tk = NULL;
	shift_reg = 0;
	i = q;
	j = 0;
...
#line 1218 "/usr/local/share/apg/apg.db"
			break;
		default:	/* token */
...
#line 1246 "/usr/local/share/apg/apg.db"
	free(b_token);
...
#line 1271 "/usr/local/share/apg/apg.db"
